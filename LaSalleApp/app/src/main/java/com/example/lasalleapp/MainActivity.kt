...
import com.example.lasalleapp.ui.utils.bottomNavBarItem
                        ...
                        bottomBar = {
                            if(currentRoute in bottomNavRoutes) {
                                AnimatedNavigationBar(
                                    ...
                                    bottomNavBarItem.forEachIndexed { index, bottomNavigationItem ->
                                        Column(
                                            ...
                                            Icon(
                                                ...
                                                tint = if (selectedItemIndex == index) Color.White else Color.Gray.copy(
                                                    alpha = 0.5f
                                                ),
                                                modifier = Modifier
                                                    .size(26.dp)
                                            ...
                                            Text(
                                                ...
                                                color = if (selectedItemIndex == index) Color.White else Color.Gray.copy(
                                                    alpha = 0.5f
                                                ),
                                            )
                                        }
...
fun HomeScreenPreview(){
    LaSalleAppTheme {
        HomeScreen(innerPadding = PaddingValues(), navController = rememberNavController())
